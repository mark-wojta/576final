...
//        String crop_loss = request.getParameter("crop_loss");
        ...
        if (event_type.equalsIgnoreCase("is_tornado")) {
            ...
            if (county != null){
                ...
                sql = "select \"Tornado\".length, \"Tornado\".magnitude, \"Tornado\".fatalities, \"Tornado\".injuries, \"Tornado\".start_lat, \"Tornado\".start_lon, \"Tornado\".end_lat, \"Tornado\".end_lon from \"Tornado\", \"Counties\" where ST_intersects (ST_Transform(\"Tornado\".geom::geometry, 3071), \"Counties\".geom::geometry) and ";
                System.out.println(county);
            }
            System.out.println("County:" + county);
            if (fatalities !=null && fatalities.equals(">5")) {
                sql += "fatalities " + fatalities;
        ...
        if (event_type.equalsIgnoreCase("is_hail")) {
            ...
            String sql = "select county, magnitude, injuries, ST_X(geom) as longitude, ST_Y(geom) as latitude from \"Hail\" ";
            ...
            if (injuries !=null && injuries.equals("> 4")){
                System.out.println("injuries > 4:" + injuries);
        ...
        if (event_type.equalsIgnoreCase("is_wind")) {
            String sql = "select injuries, magnitude, fatalities, county, ST_X(geom) as longitude, ST_Y(geom) as latitude from \"Wind\" where fatalities = " + fatalities;
...
//                m.put("event_type", res.getString("event_type"));
